                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>Edit</strong> Reason
                                        </div>
                                        <div class="card-body card-block">
                                            <form action="reason-update.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                <p style="font-size:16px; color:red" align="center">
                                                    <?php if ($msg) {
                                                        echo $msg;
                                                    }  ?> </p>
                                                <?php
                                                $sql = "select * from tblreason where reason_id=" . $_GET['id'];
                                                $data = $conn->query($sql);
                                                foreach ($data as $var) {
                                                ?>
                                                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"  />
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                            <label for="input" class=" form-control-label">Reason</label>
                                                        </div>
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="reason" name="reason" value="<?php echo $var['Reason'] ?>" class="form-control" require>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
