                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>Edit</strong> Gate
                                        </div>
                                        <div class="card-body card-block">
                                            <form action="gate-update.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                               
                                                <?php
                                                $sql = "select * from tblgate where gate_id=" . $_GET['id'];
                                                $data = $conn->query($sql);
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"  />
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                            <label for="input" class=" form-control-label">Gate</label>
                                                        </div>
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="gate" name="gate" value="<?php echo $var['gate_name'] ?>" class="form-control" require>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
