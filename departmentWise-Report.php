                ...
                <div class="main-content">
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <form action="" method="get" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="input" class="form-control-label">Employee</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                            ...
                            <?php if (isset($_GET['dept']) && $_GET['dept'] != '' && isset($_GET['emp']) && $_GET['emp'] != '') {
                            ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="table-responsive table--no-card m-b-30">
                                            <table class="table table-borderless table-striped table-earning">
                                                ...
                                                $query = "SELECT tblvisitor.FullName,tblvisitor.MobileNumber,tblvisitor.EnterDate,tblvisitor.outtime,tbldepartment.dept_name,tblemployee.emp_name FROM `tblvisitor` INNER JOIN tbldepartment ON tblvisitor.Deptartment=tbldepartment.dept_id INNER JOIN tblemployee ON tblvisitor.WhomtoMeet=tblemployee.emp_id WHERE tblvisitor.WhomtoMeet=" . $_GET['emp']." And tblvisitor.Deptartment= ". $_GET['dept']  ;
