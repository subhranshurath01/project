...
?>
    ...
    <head>
        ...
        <!-- Title Page-->
        <title>CVSM Employee Forms</title>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <form action="employee-update.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"  />
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <select id="dept" name="dept" class="form-control">
                                                                ...
                                                                ?>
                                                                    <option value="<?php echo $var['dept_id'] ?>" <?php echo $var['dept_id'] == $row['dept_id'] ? 'selected' : '' ?> ><?php echo $var['dept_name'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="fullname" name="fullname" placeholder="Full Name" class="form-control" value="<?php echo $row['emp_name'] ?>" required="">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="text" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" class="form-control" maxlength="10" value="<?php echo $row['mob'] ?>" required="">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="email" id="email" name="email" placeholder="Email Id" class="form-control" value="<?php echo $row['email'] ?>" required="">
